...
We are translating this document from russian to english and some sections are not ready yet. Please, go [here](../ru/scripts/README.md) to get full description in russian language. If you want to help us, please create pull request with translated sections. You can find our rules about working with git [here](../process/README.md#1---).
